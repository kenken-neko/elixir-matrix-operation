...
It is described the brief explanation (documents/latex_out/numerical_formula.pdf) for a mathematical description.
...
* Eigenvalue and eigenvector of R^n symmetric matrix by using Jacobi method
```elixir
...
3
```
The second argument (ex. 100) is max iterate number for QR decomposition.
